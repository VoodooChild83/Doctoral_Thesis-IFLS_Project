 ...
 */
    ...
    if (1 == 0) abort();
    {
        ...
        {
            #ifdef _OPENMP
            #pragma omp parallel num_threads(8) private(__pyx_t_10, __pyx_t_2, __pyx_t_6, __pyx_t_7, __pyx_t_8, __pyx_t_9)
            #endif /* _OPENMP */
            {
                #ifdef _OPENMP
                #pragma omp for lastprivate(__pyx_v_choice) firstprivate(__pyx_v_i) lastprivate(__pyx_v_i) lastprivate(__pyx_v_j) lastprivate(__pyx_v_k) lastprivate(__pyx_v_state) schedule(dynamic)
                #endif /* _OPENMP */
 ...
 */
      ...
      if (1 == 0) abort();
      {
          ...
          __pyx_parallel_why = 0;
              ...
              #define unlikely(x) (x)
          #endif
          __pyx_t_9 = (__pyx_t_5 - 0 + 1 - 1/abs(1)) / 1;
          if (__pyx_t_9 > 0)
          {
              #ifdef _OPENMP
              #pragma omp parallel num_threads(8) private(__pyx_t_10, __pyx_t_11, __pyx_t_12, __pyx_t_13, __pyx_t_14, __pyx_t_15, __pyx_t_16, __pyx_t_17, __pyx_t_18, __pyx_t_19) firstprivate(__pyx_t_20) private(__pyx_filename, __pyx_lineno, __pyx_clineno) shared(__pyx_parallel_why, __pyx_parallel_exc_type, __pyx_parallel_exc_value, __pyx_parallel_exc_tb)
              #endif /* _OPENMP */
              {
                  #ifdef _OPENMP
                  #ifdef WITH_THREAD
                  ...
                  #endif /* _OPENMP */
                  #ifdef _OPENMP
                  #pragma omp for lastprivate(__pyx_v_decision) firstprivate(__pyx_v_j) lastprivate(__pyx_v_j) lastprivate(__pyx_v_k) lastprivate(__pyx_v_state) schedule(dynamic)
                  #endif /* _OPENMP */
                  for (__pyx_t_8 = 0; __pyx_t_8 < __pyx_t_9; __pyx_t_8++){
                      if (__pyx_parallel_why < 2)
                      {
                          __pyx_v_j = (Py_ssize_t)(0 + 1 * __pyx_t_8);
                          /* Initialize private variables to invalid values */
                          __pyx_v_decision = ((Py_ssize_t)0xbad0bad0);
                          __pyx_v_k = ((Py_ssize_t)0xbad0bad0);
 ...
 */
                            __pyx_t_12 = (__pyx_v_state - 1);
                            __pyx_t_13 = 0;
                            __pyx_t_14 = __pyx_v_k;
                            __pyx_t_15 = (__pyx_v_state - 1);
                            __pyx_t_16 = 0;
    ...
    if (0 && (__pyx_tmp_idx < 0 || __pyx_tmp_idx >= __pyx_tmp_shape)) {
        ...
        PyErr_SetString(PyExc_IndexError, "Index out of bounds (axis 0)");
            ...
            PyGILState_Release(__pyx_gilstate_save);
            #endif
        __PYX_ERR(0, 267, __pyx_L22_error)
    }
...
(__pyx_v_states[(__pyx_v_j + (__pyx_v_i * __pyx_v_46_cython_magic_7a80b2ab25bc8891afbc568964d71b88_HH))]) = __pyx_f_46_cython_magic_7a80b2ab25bc8891afbc568964d71b88_Next_State(__pyx_t_20);
                          ...
                          #endif /* _OPENMP */
                          {
                              ...
                              __pyx_parallel_temp3 = __pyx_v_state;
                          }
                          __pyx_L27:;
                          #ifdef _OPENMP
                  ...
                  #else
{
          ...
          if (__pyx_parallel_why) {
            __pyx_v_decision = __pyx_parallel_temp0;
            __pyx_v_j = __pyx_parallel_temp1;
            __pyx_v_k = __pyx_parallel_temp2;
            __pyx_v_state = __pyx_parallel_temp3;
...
static PyObject *__pyx_pw_46_cython_magic_7a80b2ab25bc8891afbc568964d71b88_1Sim_Model(PyObject *__pyx_self, PyObject *__pyx_args, PyObject *__pyx_kwds) {
  ...
  __Pyx_RefNannySetupContext("Sim_Model (wrapper)", 0);
  {
    ...
    if (unlikely(__pyx_kwds)) {
      ...
      switch (pos_args) {
        ...
        if (likely((values[1] = PyDict_GetItem(__pyx_kwds, __pyx_n_s_alpha)) != 0)) kw_args--;
          ...
          __Pyx_RaiseArgtupleInvalid("Sim_Model", 1, 11, 11, 1); __PYX_ERR(0, 202, __pyx_L3_error)
        }
        case  2:
        if (likely((values[2] = PyDict_GetItem(__pyx_kwds, __pyx_n_s_wages)) != 0)) kw_args--;
        else {
          __Pyx_RaiseArgtupleInvalid("Sim_Model", 1, 11, 11, 2); __PYX_ERR(0, 202, __pyx_L3_error)
        }
        case  3:
        if (likely((values[3] = PyDict_GetItem(__pyx_kwds, __pyx_n_s_child)) != 0)) kw_args--;
        else {
          __Pyx_RaiseArgtupleInvalid("Sim_Model", 1, 11, 11, 3); __PYX_ERR(0, 202, __pyx_L3_error)
        }
        case  4:
        if (likely((values[4] = PyDict_GetItem(__pyx_kwds, __pyx_n_s_move)) != 0)) kw_args--;
        else {
          __Pyx_RaiseArgtupleInvalid("Sim_Model", 1, 11, 11, 4); __PYX_ERR(0, 202, __pyx_L3_error)
        }
        case  5:
        if (likely((values[5] = PyDict_GetItem(__pyx_kwds, __pyx_n_s_tranny)) != 0)) kw_args--;
        else {
          __Pyx_RaiseArgtupleInvalid("Sim_Model", 1, 11, 11, 5); __PYX_ERR(0, 202, __pyx_L3_error)
        }
        case  6:
        if (likely((values[6] = PyDict_GetItem(__pyx_kwds, __pyx_n_s_demos)) != 0)) kw_args--;
        else {
          __Pyx_RaiseArgtupleInvalid("Sim_Model", 1, 11, 11, 6); __PYX_ERR(0, 202, __pyx_L3_error)
        }
        case  7:
        if (likely((values[7] = PyDict_GetItem(__pyx_kwds, __pyx_n_s_dec_freq)) != 0)) kw_args--;
        else {
          __Pyx_RaiseArgtupleInvalid("Sim_Model", 1, 11, 11, 7); __PYX_ERR(0, 202, __pyx_L3_error)
        }
        case  8:
        if (likely((values[8] = PyDict_GetItem(__pyx_kwds, __pyx_n_s_states_freq)) != 0)) kw_args--;
        else {
          __Pyx_RaiseArgtupleInvalid("Sim_Model", 1, 11, 11, 8); __PYX_ERR(0, 202, __pyx_L3_error)
        }
        case  9:
        if (likely((values[9] = PyDict_GetItem(__pyx_kwds, __pyx_n_s_CCPs)) != 0)) kw_args--;
        else {
          __Pyx_RaiseArgtupleInvalid("Sim_Model", 1, 11, 11, 9); __PYX_ERR(0, 202, __pyx_L3_error)
        }
        case 10:
        if (likely((values[10] = PyDict_GetItem(__pyx_kwds, __pyx_n_s_init_states)) != 0)) kw_args--;
        else {
          __Pyx_RaiseArgtupleInvalid("Sim_Model", 1, 11, 11, 10); __PYX_ERR(0, 202, __pyx_L3_error)
        }
      }
      if (unlikely(kw_args > 0)) {
        if (unlikely(__Pyx_ParseOptionalKeywords(__pyx_kwds, __pyx_pyargnames, 0, values, pos_args, "Sim_Model") < 0)) __PYX_ERR(0, 202, __pyx_L3_error)
      }
    ...
    __pyx_v_V = __Pyx_PyObject_to_MemoryviewSlice_ds_double(values[0]); if (unlikely(!__pyx_v_V.memview)) __PYX_ERR(0, 202, __pyx_L3_error)
    __pyx_v_alpha = __pyx_PyFloat_AsDouble(values[1]); if (unlikely((__pyx_v_alpha == (double)-1) && PyErr_Occurred())) __PYX_ERR(0, 202, __pyx_L3_error)
    __pyx_v_wages = __Pyx_PyObject_to_MemoryviewSlice_dsdsds_double(values[2]); if (unlikely(!__pyx_v_wages.memview)) __PYX_ERR(0, 202, __pyx_L3_error)
    __pyx_v_child = __Pyx_PyObject_to_MemoryviewSlice_dsdsds_double(values[3]); if (unlikely(!__pyx_v_child.memview)) __PYX_ERR(0, 203, __pyx_L3_error)
    __pyx_v_move = __Pyx_PyObject_to_MemoryviewSlice_dsds_double(values[4]); if (unlikely(!__pyx_v_move.memview)) __PYX_ERR(0, 203, __pyx_L3_error)
    __pyx_v_tranny = __Pyx_PyObject_to_MemoryviewSlice_dsdsds_double(values[5]); if (unlikely(!__pyx_v_tranny.memview)) __PYX_ERR(0, 204, __pyx_L3_error)
    __pyx_v_demos = __Pyx_PyObject_to_MemoryviewSlice_ds_int(values[6]); if (unlikely(!__pyx_v_demos.memview)) __PYX_ERR(0, 205, __pyx_L3_error)
    __pyx_v_dec_freq = __Pyx_PyObject_to_MemoryviewSlice_dsds_double(values[7]); if (unlikely(!__pyx_v_dec_freq.memview)) __PYX_ERR(0, 205, __pyx_L3_error)
    __pyx_v_states_freq = __Pyx_PyObject_to_MemoryviewSlice_dsds_double(values[8]); if (unlikely(!__pyx_v_states_freq.memview)) __PYX_ERR(0, 206, __pyx_L3_error)
    __pyx_v_CCPs = __Pyx_PyObject_to_MemoryviewSlice_dsds_double(values[9]); if (unlikely(!__pyx_v_CCPs.memview)) __PYX_ERR(0, 206, __pyx_L3_error)
    __pyx_v_init_states = __Pyx_PyObject_to_MemoryviewSlice_ds_double(values[10]); if (unlikely(!__pyx_v_init_states.memview)) __PYX_ERR(0, 206, __pyx_L3_error)
  }
...
static PyObject *__pyx_pf_46_cython_magic_7a80b2ab25bc8891afbc568964d71b88_Sim_Model(CYTHON_UNUSED PyObject *__pyx_self, __Pyx_memviewslice __pyx_v_V, double __pyx_v_alpha, __Pyx_memviewslice __pyx_v_wages, __Pyx_memviewslice __pyx_v_child, __Pyx_memviewslice __pyx_v_move, __Pyx_memviewslice __pyx_v_tranny, __Pyx_memviewslice __pyx_v_demos, __Pyx_memviewslice __pyx_v_dec_freq, __Pyx_memviewslice __pyx_v_states_freq, __Pyx_memviewslice __pyx_v_CCPs, __Pyx_memviewslice __pyx_v_init_states) {
  ...
  if (unlikely(!__pyx_v_V.memview)) { __Pyx_RaiseUnboundLocalError("V"); __PYX_ERR(0, 202, __pyx_L1_error) }
  if (unlikely(!__pyx_v_wages.memview)) { __Pyx_RaiseUnboundLocalError("wages"); __PYX_ERR(0, 202, __pyx_L1_error) }
  if (unlikely(!__pyx_v_child.memview)) { __Pyx_RaiseUnboundLocalError("child"); __PYX_ERR(0, 202, __pyx_L1_error) }
  if (unlikely(!__pyx_v_move.memview)) { __Pyx_RaiseUnboundLocalError("move"); __PYX_ERR(0, 202, __pyx_L1_error) }
  if (unlikely(!__pyx_v_tranny.memview)) { __Pyx_RaiseUnboundLocalError("tranny"); __PYX_ERR(0, 202, __pyx_L1_error) }
  if (unlikely(!__pyx_v_demos.memview)) { __Pyx_RaiseUnboundLocalError("demos"); __PYX_ERR(0, 202, __pyx_L1_error) }
  if (unlikely(!__pyx_v_dec_freq.memview)) { __Pyx_RaiseUnboundLocalError("dec_freq"); __PYX_ERR(0, 202, __pyx_L1_error) }
