...
// Make the data longitudinal
	...
	* Remove people who have schooling finish past 2016 ( the absolute last year that interviews took place
	
		by pidlink: egen YearMax=max(year)
		drop if YearMax>2016
			drop YearMax
...
save "$maindir$tmp/Longitudinal Data Set - Education.dta", replace
