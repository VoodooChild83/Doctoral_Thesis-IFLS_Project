// 2000 Wage History Cleaning File - First Job

********************************************************************************
// Raw data

use "$maindir$wave_3/b3a_tk4.dta"
...
// Generate the monthly wages: these should be mutually exclusive
	...
	egen wage_mth=rsum(tk56 tk57n tk57g), missing
...
save "$maindir$tmp/2000 Wage PreHistory.dta", replace
