// 2014 Work Experience of those who no longer work

********************************************************************************
// 2014 work experience: stoppage of work and year

use "$maindir$wave_5/b3a_tk1.dta"
...
keep  pidlink year r_wage_mth stopped_wrk retired neverwrkd stopped_2006 unpaid
	
order pidlink year unpaid stopped_2006 stopped_wrk retired neverwrkd r_wage_mth 
	
gen dataset="3"

gen wave=20014

save "$maindir$tmp/20014 Wage Last Job.dta", replace
