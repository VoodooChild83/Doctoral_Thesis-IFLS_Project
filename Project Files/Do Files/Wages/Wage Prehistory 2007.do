// 2007 Wage History Cleaning File - First Job & Last Paying Job

********************************************************************************
// Raw data

use "$maindir$wave_4/b3a_tk4.dta"

********************************************************************************
// Cleanup the occupation string variable: remove the initial 0

	replace occ2007=substr( occ2007, 2,.) if  occ2007!="999" // code 999 is the unknown code
...
save "$maindir$tmp/2007 Wage PreHistory.dta", replace
