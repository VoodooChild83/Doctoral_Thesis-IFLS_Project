// 2014 Work Experience of those who are currently working


********************************************************************************
// 2014 work experience: current and secondary job

use "$maindir$wave_5/b3a_tk2.dta"
...
rename (occ2014_primary tk22a tk23a tk23a2y) (occ2 hrs_wk wks_yr tot_yrs)
...
save "$maindir$tmp/2014 Wage Current Occup 1.dta",replace
...
rename (occ2014_secondary tk22b tk23b tk23b2y) (occ2 hrs_wk wks_yr tot_yrs)
...
save "$maindir$tmp/2014 Wage Current Occup 2.dta",replace
...
append using "$maindir$tmp/2014 Wage Current Occup 1.dta"
...
save "$maindir$tmp/2014 Wage Current.dta", replace

forvalues x=1/2{

	erase "$maindir$tmp/2014 Wage Current Occup `x'.dta"
	}
