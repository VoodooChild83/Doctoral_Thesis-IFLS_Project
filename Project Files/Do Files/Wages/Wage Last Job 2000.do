// 2000 Work Experience of those who no longer work

********************************************************************************
// 2000 work experience: stoppage of work and year

use "$maindir$wave_3/b3a_tk1.dta"
...
gen stopped_1995=1 if tk06==1

gen dum_nvrwrkd=1 if tk05==3
gen dum=1 if (tk01!=5 & year!=.)
gen dum2=1 if stopped_1995==1
...
keep  pidlink year r_wage_mth stopped_wrk retired neverwrkd stopped_1995 unpaid
	
order pidlink year unpaid stopped_1995 stopped_wrk retired neverwrkd r_wage_mth 
	
gen dataset="3"

gen wave=2000

save "$maindir$tmp/2000 Wage Last Job.dta", replace
