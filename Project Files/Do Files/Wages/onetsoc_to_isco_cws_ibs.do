/*
*******************************
The code was prepared by the Institute for Structural Research.
In case of using it please include the following citation:
Codes provided by the Institute for Structural Research, www.ibs.org.pl/resources/
*******************************
...
global source "$maindir$project$ONET/db_21_1_excel"   

//insert the path to your crosswalks directory.
global crosswalks "$maindir$project$ONET/onetsoc_to_isco_cws_ibs"
...
global output "$maindir$project$ONET/ONET Occupation Skills"
